    ...
    def 입장(self):
        ...
        if 행동 == "발사!":
            print(dedent("""
                ...
                고던인의 광대 옷이 휘날려 몸을 숨기고 당신의 조준을 흩뜨립니다.
                광선은 옷을 맞추었지만 고던인은 완전히 놓쳐버립니다.
                어머니가 사준 신상 옷을 모조리 망쳐버리자 고던인은 광기 어린 분노에
                빠져들어 당신이 죽을 때까지 얼굴을 쏘아댑니다. 고던인은 당신을 먹어치웁니다.
                """))
            return '사망'
            ...
            print(dedent("""
                ...
                합니다. 예술적인 회피를 하는 와중 그만 발이 미끄러져 금속 벽에
                머리를 찧고 기절합니다. 잠시 후 정신을 차리지만
            ...
            print(dedent("""
                ...
                터지자 꼼짝도 하지 못합니다. 당신은 고던인이 웃어대는 틈에
                뛰쳐나가 정통으로 머리를 맞춰 쓰러뜨리고 무기고의 문으로 뛰어듭니다.
                """))
            return '레이저_무기고'
...
class 레이저_무기고(장면):
    ...
    def 입장(self):
        print(dedent("""
            ...
            숨어있을지도 모르는 고던인을 찾아 방을 살핍니다. 쥐 죽은듯이,
            지나칠 만큼 조용합니다. 일어서서는 문 건너편으로
            달려 보관함에서 중성장파괴탄을 찾습니다. 보관함은
            비밀번호로 잠겨 있고 중성자파괴탄을 꺼내려면 비밀번호를 알아내야만
            합니다. 비밀번호를 10번 틀리면 자물쇠는 영원히 잠기고 폭탄은 꺼낼 수
            없습니다. 비밀번호는 3자리 수입니다.
        """))
